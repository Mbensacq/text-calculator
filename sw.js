 ...
 */
const CACHE = 'text-calculator-v32';

const ASSETS = [
  './',
  './index.html',
  './manifest.webmanifest',
  './styles/main.css?v=32',
  './src/units.js?v=32',
  './src/tokenizer.js?v=32',
  './src/parser.js?v=32',
  './src/evaluator.js?v=32',
  './src/formatter.js?v=32',
  './src/engine.js?v=32',
  './src/editor.js?v=32',
  './src/storage.js?v=32',
  './src/grid.js?v=32',
  './src/grid-editor.js?v=32',
  './src/simplify.js?v=32',
