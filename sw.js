 ...
 */
const CACHE = 'text-calculator-v30';
...
const ASSETS = [
  ...
  './src/units.js?v=30',
  './src/tokenizer.js?v=30',
  './src/parser.js?v=30',
  './src/evaluator.js?v=30',
  './src/formatter.js?v=30',
  './src/engine.js?v=30',
  './src/editor.js?v=30',
  './src/storage.js?v=30',
  './src/grid.js?v=30',
  './src/grid-editor.js?v=30',
  './src/simplify.js?v=30',
  './src/command-palette.js?v=30',
  './src/undo.js?v=30',
  './src/history.js?v=30',
  './src/templates.js?v=30',
  './src/note-editor.js?v=30',
  './src/sync.js?v=30',
  './src/app.js?v=30',
  './icons/icon-192.png',
  './icons/icon-512.png',
