 ...
 */
const CACHE = 'text-calculator-v24';
...
const ASSETS = [
  ...
  './src/units.js?v=24',
  './src/tokenizer.js?v=24',
  './src/parser.js?v=24',
  './src/evaluator.js?v=24',
  './src/formatter.js?v=24',
  './src/engine.js?v=24',
  './src/editor.js?v=24',
  './src/storage.js?v=24',
  './src/grid.js?v=24',
  './src/grid-editor.js?v=24',
  './src/simplify.js?v=24',
  './src/note-editor.js?v=24',
  './src/sync.js?v=24',
  './src/app.js?v=24',
  './icons/icon-192.png',
  './icons/icon-512.png',
