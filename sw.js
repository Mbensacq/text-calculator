 ...
 */
const CACHE = 'text-calculator-v36';

const ASSETS = [
  './',
  './index.html',
  './manifest.webmanifest',
  './styles/main.css?v=36',
  './src/units.js?v=36',
  './src/tokenizer.js?v=36',
  './src/parser.js?v=36',
  './src/evaluator.js?v=36',
  './src/formatter.js?v=36',
  './src/engine.js?v=36',
  './src/editor.js?v=36',
  './src/storage.js?v=36',
  './src/grid.js?v=36',
  './src/grid-editor.js?v=36',
  './src/simplify.js?v=36',
  './src/command-palette.js?v=36',
  './src/undo.js?v=36',
  './src/history.js?v=36',
  './src/settings.js?v=36',
  './src/templates.js?v=36',
  './src/note-editor.js?v=36',
  './src/sync.js?v=36',
  './src/app.js?v=36',
  './icons/icon-192.png',
  './icons/icon-512.png',
