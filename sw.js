 ...
 */
const CACHE = 'text-calculator-v33';

const ASSETS = [
  './',
  './index.html',
  './manifest.webmanifest',
  './styles/main.css?v=33',
  './src/units.js?v=33',
  './src/tokenizer.js?v=33',
  './src/parser.js?v=33',
  './src/evaluator.js?v=33',
  './src/formatter.js?v=33',
  './src/engine.js?v=33',
  './src/editor.js?v=33',
  './src/storage.js?v=33',
  './src/grid.js?v=33',
  './src/grid-editor.js?v=33',
  './src/simplify.js?v=33',
  './src/command-palette.js?v=33',
  './src/undo.js?v=33',
  './src/history.js?v=33',
  './src/settings.js?v=33',
  './src/templates.js?v=33',
  './src/note-editor.js?v=33',
  './src/sync.js?v=33',
  './src/app.js?v=33',
  './icons/icon-192.png',
  './icons/icon-512.png',
