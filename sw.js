 ...
 */
const CACHE = 'text-calculator-v31';
...
const ASSETS = [
  ...
  './src/units.js?v=31',
  './src/tokenizer.js?v=31',
  './src/parser.js?v=31',
  './src/evaluator.js?v=31',
  './src/formatter.js?v=31',
  './src/engine.js?v=31',
  './src/editor.js?v=31',
  './src/storage.js?v=31',
  './src/grid.js?v=31',
  './src/grid-editor.js?v=31',
  './src/simplify.js?v=31',
  './src/command-palette.js?v=31',
  './src/undo.js?v=31',
  './src/history.js?v=31',
  './src/templates.js?v=31',
  './src/note-editor.js?v=31',
  './src/sync.js?v=31',
  './src/app.js?v=31',
  './icons/icon-192.png',
  './icons/icon-512.png',
