 ...
 */
const CACHE = 'text-calculator-v34';
...
const ASSETS = [
  ...
  './src/units.js?v=34',
  './src/tokenizer.js?v=34',
  './src/parser.js?v=34',
  './src/evaluator.js?v=34',
  './src/formatter.js?v=34',
  './src/engine.js?v=34',
  './src/editor.js?v=34',
  './src/storage.js?v=34',
  './src/grid.js?v=34',
  './src/grid-editor.js?v=34',
  './src/simplify.js?v=34',
  './src/command-palette.js?v=34',
  './src/undo.js?v=34',
  './src/history.js?v=34',
  './src/settings.js?v=34',
  './src/templates.js?v=34',
  './src/note-editor.js?v=34',
  './src/sync.js?v=34',
  './src/app.js?v=34',
  './icons/icon-192.png',
  './icons/icon-512.png',
